...
import com.bangkit.storyapp.ui.activity.NewStoryActivity.Companion.CAMERA_X_RESULT
...
class CameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imgBtnCapture.setOnClickListener { takePhoto() }
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onError(exc: ImageCaptureException) {
                    Helper.showToast(applicationContext,getString(R.string.unable_cam))
                }
                ...
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    ...
                    intent.putExtra(
                        "isBackCamera",
                        camSelector == CameraSelector.DEFAULT_BACK_CAMERA
                    )
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Helper.showToast(this,getString(R.string.unable_cam))
            }
        }, ContextCompat.getMainExecutor(this))
    }
